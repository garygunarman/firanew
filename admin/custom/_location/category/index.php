          ...
          <form method="post" enctype="multipart/form-data">
            <div class="subnav">
              <div class="container clearfix">
                <h1><span class="glyphicon glyphicon-list"></span> &nbsp; Location City</h1>
                <div class="btn-placeholder">
                  <a href="<?php echo BASE_URL.'add-location-city';?>">
                    <input type="button" class="btn btn-success btn-sm" value="Add City">
                  </a>
                </div>
              </div>
            </div>
                ...
                <div class="content">
                  <div class="actions clearfix">
                    ...
                    <div class="pull-right">
                      ...
                      <input type="submit" class="btn btn-success pull-left" name="btn-index-news-category" value="GO">
                    </div>
                  </div><!--actions-->
                  <table class="table" id="id-tbl-category">
                    <thead>
                      <tr class="headings">
                        ...
                        <th class="sort" width="680" onclick="sortBy('category_name')">City Name<?php echo $arr_category_name;?></th>
                        <th class="sort" width="70">Locations</th>
                      ...
                      <tbody onload="loading()" id="checkbox">
                        ...
                        <tr class="" id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                          ...
                          <td>
                            <a href="<?php echo BASE_URL.'location-city-detail/'.$list_category->category_id.'/'.cleanurl($list_category->category_name);?>">
...
<script src="<?php echo BASE_URL;?>custom/script/_location/location-city.js"></script>
