          ...
          <form method="post" enctype="multipart/form-data">
            <div class="sub-header clearfix">
              <div class="content">
                ...
                <h2><?php echo $data_account->account_name.' - '.$data_account->account_number;?></h2>
                <div class="btn-placeholder">
                  <a href="<?php echo BASE_URL.'news';?>">
                    <input type="button" class="btn grey main" value="Cancel">
                  </a>
                  
                  <a href="<?php echo BASE_URL.'news-edit/'.$news_detail['news_id'].cleanurl($news_detail['news_title'])?>">
