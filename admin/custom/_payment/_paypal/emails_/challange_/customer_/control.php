...
if($get_order->order_payment_method == 'paypal'){
   $get_order->order_payment_method = 'Paypal';
}else{
						  ...
						  <tr>
						    <td>
							  ...
							  <td style="font-size: 12px; color: #fff; padding: 10px 15px; text-align: right">
							    <span style="line-height: 18px; color: #999"><b style="color: #eea236">ORDER PLACED</b> </span>
						      </td>
							</td>
						  </tr>
						</table>
				  ...
				  <tbody>
				    <tr>
					  <td width="600" bgcolor="#fff" style="padding: 25px">
						...
						<br>
						Thank you for placing your order at '.$_global_general->website_title.'. Your order number is <b>'.$order_number.'</b>. Please wait while <b>Paypal</b> review the payment. Once the payment has been reviewed and verified, we will notify you and process your order. Thank you!<br>
						<br>
						<i style="color: #cc0000">*Please note that for payments made via eCheck, 3-4 days is required for review and clearance.</i>
					  </td>
					</tr>
				  <tr>
				<td>
