...
if($cart->order_confirm_bank == ''){
   ...
   if($cart->order_confirm_bank == 'cc'){
      $cart->order_confirm_bank = 'Credit Card via Veritrans';
   }else{
...
$mail_body .= '                 <tr>
								  ...
								  <td style="border-bottom: 1px solid #ccc;">'.$cart->currency.' '.price(CURRENCY, $price).'</td>
								  <td style="border-bottom: 1px solid #ccc; text-align: center">'.$item->item_quantity.'</td>
								  <td style="border-bottom: 1px solid #ccc; text-align: right; padding-right: 5px">'.$cart->currency.' '.price(CURRENCY, $sub_item).'</td>
								</tr>';
						    ...
						    <table width="540" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size: 11px; line-height: 16px; padding-top: 7px">
							  <tbody>
							    <tr>
								  ...
								  <td style="padding-bottom: 5px; padding-right: 5px; text-align: right">'.$cart->currency.' '.price(CURRENCY, $cart->order_shipping_amount).'</td>
								</tr>
								<tr>
								  ...
								  <td style="border-top: 1px solid #ccc; padding-right: 5px; font-size: 14px; text-align: right">
								    <b>'.$cart->currency.' '.price(CURRENCY, $cart->order_total_amount).'</b>
								  </td>
								</tr>
							  </tbody>
							</table>
