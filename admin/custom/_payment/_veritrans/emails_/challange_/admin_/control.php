				  ...
				  <tbody>
				    <tr>
					  <td width="600" style="padding: 25px">
						...
						<br>
						The total amount of <b>'.$get_order->currency.' '.price(CURRENCY, $get_order->order_total_amount).'</b> has been paid via <b>'.$get_order->order_payment_method.'</b>
						with the following details:<br>
						<br>
						<b>Paid via:</b> '.$get_order->order_confirm_bank.'<br>
						<b>Amount:</b> '.$currency.' '.price(CURRENCY, $get_order->order_confirm_amount).'<br>
						<br>
						Please check at <a href="http://my.veritrans.co.id" style="color:#0383ae; font-weight:bold;">Veritrans</a> dashboard panel. Once the payment has been verified, go to your admin panel and mark the order as paid.
					  </td>
					</tr>
					<tr>
					  <td>
