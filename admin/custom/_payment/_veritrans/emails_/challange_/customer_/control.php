				  ...
				  <tbody>
				    <tr>
					  <td width="600" bgcolor="#fff" style="padding: 25px">
						...
						<br>
						Thank you for placing your order at '.$_global_general->website_title.'. Your order number is <b>'.$order_number.'</b>. Please wait while we&#39;re verifying the payment. Once the payment has been verified, we will notify you and process your order. Thank you!<br>
						<br>
					  </td>
					</tr>
				  <tr>
