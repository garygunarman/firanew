				  ...
				  <tbody>
				    <tr>
					  <td width="600" bgcolor="#fff" style="padding: 25px">
						...
						<br>
						Thank you for placing your order at '.$_global_general->website_title.'. However your order <b>'.$order_number.'</b> is cancelled because your payment is denied by Veritrans.
					  </td>
					</tr>
				  <tr>
				<td>
