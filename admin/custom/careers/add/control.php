...
$full_order  = $_get->count_city($search_query, $sort_by, $query_per_page);
$total_query = $full_order['total_query'];
$total_page  = $full_order['total_page'];

// CALL FUNCTION
$listing_order = $_get->get_city($search_query, $sort_by, $first_record, $query_per_page);
...
if(isset($_POST['btn_add_city'])){
   ...
   $_update->insert($city_name, $active, $visibility);
