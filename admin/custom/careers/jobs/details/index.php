        ...
        <div class="content col-xs-9">
          <ul class="form-set" id="custom_product_category">
			...
			<li class="form-group row" id="lbl_career_reports">
              ...
              <div class="col-xs-9">
                <input type="text" class="form-control" name="career_reports" placeholder="" id="id_career_reports" value="<?php echo $category->reports;?>">
              </div>
            </li>
			...
			<li class="form-group row" id="lbl_career_education">
              ...
              <div class="col-xs-9">
                <input type="text" class="form-control" name="career_education" placeholder="ex: Bachelor's degree required." id="id_career_education" value="<?php echo $category->education;?>">
              </div>
            </li>
