          ...
          <form method="post">
            <div class="subnav clearfix">
              <div class="container clearfix">
                <h1><span class="glyphicon glyphicon-list"></span> &nbsp; Career</h1>
                ...
                <div class="btn-placeholder">
                  <a href="<?php echo BASE_URL."add-career"?>">
                    <input type="button" class="btn btn-success btn-sm" value="Add Career">
                  </a>
                </div>
              </div>
            </div>
                ...
                <div class="content">
                 ...
                 <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     ...
                     <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_index_job">
                   </div>
                 </div><!--actions-->
                 ...
                 <table class="table">
                   <thead>
                     <tr class="headings">
                       ...
                       <th class="sort" width="95%" onclick="sortBy('career_name')">Position<?php echo $arr_order_number;?></th>
                   ...
                   <tbody>
				     ...
				     foreach($listing_order as $all_category){
					    ...
					    // CALL FUNCTION
					    $detail = $_get->get_detail($all_category->career_id);
					 ?>
                     ...
                     <td>
					   <a href="<?php echo BASE_URL.'career-detail/'.$all_category->career_id.'/'.cleanurl($all_category->career_name);?>">
