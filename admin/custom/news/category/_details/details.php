...
?>
      ...
      <div class="container clearfix">
        <h1>
          <a href="<?php echo BASE_URL."news-category"?>">
            <span class="fa fa-chevron-left"></span>&nbsp; Edit News Category
          </a> 
        </h1>
        ...
        <div class="content col-xs-9">
          <ul class="form-set" id="custom_product_category">
            <li class="form-group row hidden" id="id-row-active">
              ...
              <div class="col-xs-9">
                <label class="radio-inline control-label">
                  <input type="radio" value="Active" name="active" checked="checked" id="id-active">Active
                </label>
                <label class="radio-inline control-label">
            ...
            <li class="form-group row hidden" id="id-row-description">
              ...
              <div class="col-xs-9">
                <textarea class="form-control" name="description" id="id-description" rows="8"><?php echo $detail_category->category_description;?></textarea>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="box row hidden">
        ...
        <div class="content col-xs-9">
            <li class="form-group row" id="id-row-meta-description">
              ...
              <div class="col-xs-9">
                <textarea class="form-control" name="meta_description" id="id-meta-description" rows="5"><?php echo $detail_category->meta_descriptions;?></textarea>
              </div>
            </li>
  ...
  <script src="<?php echo BASE_URL;?>custom/script/news-category-details.js"></script>