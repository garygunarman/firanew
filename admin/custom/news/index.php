              ...
              <div class="container clearfix">
                ...
                <div class="btn-placeholder">
                  <a href="<?php echo BASE_URL.'add-news';?>">
                    <input type="button" class="btn btn-success btn-sm" value="Add News" id="id-btn-add-news">
                  </a>
                </div>
              </div>
            </div>
                ...
                <div class="content">
                  <div class="actions clearfix">
                    ...
                    <div class="pull-right">
                      ...
                      <input type="submit" class="btn btn-success pull-left" value="GO" name="btn-index-news" id="id-btn-index-news">
                    </div>
                  </div><!--actions-->
                  <table class="table">
                    <thead>
                    ...
                    <tbody>
                      ...
                      <tr id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                        ...
                        <td><a href="<?php echo BASE_URL.'news-detail/ID/'.$all_news->news_id."/".cleanurl($all_news->news_title);?>"><?php echo $all_news->news_title;?></a></td>
...
<script src="<?php echo BASE_URL;?>custom/script/news.js"></script>           