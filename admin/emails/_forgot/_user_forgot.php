...
include('control.php');
					    ...
					    <tbody>
						  <tr>
						    <td width="600" style="padding: 25px">
							  You have requested to reset your password for username <b>'.$data->user_fullname.'</b> <br>
							  <br>
							  <a href="'.BASE_URL.'../../../reset-password/'.$code.'" style="color: #ffffff;
	  ...
	  $subject   = '['.$_global_general->website_title.'] Account Forgot Password';
