...
$subject   = "[".$_global_general->website_title."] ".$order_number." Cancelled"; 
...
$page = 'order-detailing/'.$order_number;
$type = 'success';
$msg  = 'Successfully sent email notification to: '.$get_order->order_billing_email;
