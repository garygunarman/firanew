...
/*
* ----------------------------------------------------------------------
* EMAIL - NOTIFICATION VERIFIED CUSTOMER: VIEW
* ----------------------------------------------------------------------
*/
...
$recipient = $detail->order_billing_email; 

$subject   = '['.$_global_general->website_title.'] '.$order_number.' Payment Verified';
...
$note			= 'to '.$_mailgun_to;
$_global->update_log($detail->order_id, $description, $note, $created_date);


/* --- EMAIL: ADMIN --- */
//safe_redirect('order-verified-warehouse/'.$order_number);
?>