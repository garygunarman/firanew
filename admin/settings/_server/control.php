...
if(isset($_POST['btn-notification']) && $_POST['btn-notification'] == 'Save Changes'){
   ...
   if($check->rows > 0){
	  $_update->update_notification($logo, $email_order, $email_warehouse, $notification_id);
	  
	  $type = 'success';
	  $msg  = 'Changes successfully saved';
	  
   }else{
      $_update->insert_notification($notification_id, $logo, $email_order, $email_warehouse);
