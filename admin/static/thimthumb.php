...
class timthumb {
        ...
        protected $salt 					= "";
        protected $fileCacheVersion 		= 1; //Generally if timthumb.php is modifed then the salt changes and all cache files are recreated. This is a backup mechanism to force regen.
